...
# WRITE YOUR SOLUTION BELOW:
bitcoin-cli -rpcwallet=treasurewallet getnewaddress "Mining Address"
...
bitcoin-cli -rpcwallet=btrustwallet getnewaddress "Legacy Address" legacy

# Generate a P2SH-SegWit (Nested SegWit) address (starts with "3")
bitcoin-cli -rpcwallet=btrustwallet getnewaddress "P2SH-SegWit Address" p2sh-segwit

# Generate a Bech32 (Native SegWit) address (starts with "bc1q")
bitcoin-cli -rpcwallet=btrustwallet getnewaddress "Bech32 Address" bech32

# Generate a Bech32m (Taproot) address (starts with "bc1p")
bitcoin-cli -rpcwallet=btrustwallet getnewaddress "Bech32m Address" bech32m
...
# WRITE YOUR SOLUTION BELOW:
bitcoin-cli -rpcwallet=btrustwallet getbalance
bitcoin-cli -rpcwallet=btrustwallet getreceivedbylabel ""
echo "Total Treasure Collected: $(bitcoin-cli -rpcwallet=btrustwallet getbalance - starting_balance) BTC"
...
# WRITE YOUR SOLUTION BELOW:
bitcoin-cli validateaddress "<P2SH_ADDRESS>"
